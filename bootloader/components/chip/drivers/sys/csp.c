...
csp_adc_t 		*ADC0    	= (csp_adc_t 	*)(APB_ADC_BASE);
...
csp_spi_t  		*SPI0     	= (csp_spi_t 	*)(APB_SPI_BASE);
csp_sio_t  		*SIO0     	= (csp_sio_t 	*)(APB_SIO_BASE);
csp_i2c_t  		*I2C0     	= (csp_i2c_t 	*)(APB_I2C_BASE);
csp_cnta_t  	*CNTA      	= (csp_cnta_t 	*)(APB_CNTA_BASE);
csp_gpta_t 		*GPTA0     	= (csp_gpta_t 	*)(APB_GPTA_BASE);
csp_ept_t 		*EPT0     	= (csp_ept_t 	*)(APB_EPT_BASE);
